...
class Aluno(models.Model):    
    ...
    aluno_usuario = models.OneToOneField(User, on_delete=models.CASCADE, null=False)
...
class Motorista(models.Model):
    ...
    motorista_usuario = models.OneToOneField(User, on_delete=models.CASCADE, null=False)
